#include "vtkSciVizHighestDensityRegionsStats.h"
...
vtkStandardNewMacro(vtkSciVizHighestDensityRegionsStats);
...
void vtkSciVizHighestDensityRegionsStats::PrintSelf( ostream& os, vtkIndent indent )
{
  this->Superclass::PrintSelf( os, indent );
}

int vtkSciVizHighestDensityRegionsStats::LearnAndDerive( vtkMultiBlockDataSet* modelDO, vtkTable* inData )
{
  // Create the statistics filter and run it
  vtkNew<vtkHighestDensityRegionsStatistics> stats;
...
int vtkSciVizHighestDensityRegionsStats::AssessData( vtkTable* observations, vtkDataObject* assessedOut, vtkMultiBlockDataSet* modelOut )
{
  if ( ! assessedOut )
    {
